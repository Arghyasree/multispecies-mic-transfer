...
EXPECTED_ROWS = 313_910
EXPECTED_IDENTITIES = 83
EXPECTED_PAIRS = 288_772
EXPECTED_SINGLETON_PAIRS = 265_155
EXPECTED_REPEATED_PAIRS = 23_617
EXPECTED_REPEATED_RECORDS = 48_755
...
def main() -> None:
    ...
    outputs = {
        RESULT_ROOT
        / "postqc_mapping_clean_monotherapy_duplicate_overall_summary.tsv":
            overall_summary,

        RESULT_ROOT
        / "postqc_mapping_clean_monotherapy_duplicate_class_summary.tsv":
            class_summary,

        RESULT_ROOT
        / "postqc_mapping_clean_monotherapy_duplicate_group_size_distribution.tsv":
            size_distribution,

        RESULT_ROOT
        / "postqc_mapping_clean_monotherapy_duplicate_species_summary.tsv":
            species_summary,

        RESULT_ROOT
        / "postqc_mapping_clean_monotherapy_duplicate_antibiotic_summary.tsv":
            antibiotic_summary,

        AUDIT_ROOT
        / "postqc_mapping_clean_monotherapy_repeated_group_audit.tsv":
            repeated_audit,

        AUDIT_ROOT
        / "postqc_mapping_clean_monotherapy_conflicting_records.tsv":
            conflict_records,
    }
