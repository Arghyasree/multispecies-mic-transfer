...
namespace = {
    "__name__": "script156_base",
    "__file__": str(Path(__file__).resolve()),
    "BASE_RUNNER_PATH": BASE_RUNNER_PATH,
    "SCRIPT155_FREEZE": SCRIPT155_FREEZE,
...
namespace.update(
    {
        ...
        "SCRIPT142_OUTPUTS_PATH": SCRIPT155_FREEZE,
        "SCRIPT142_FROZEN_PATH": SCRIPT155_FREEZE,
        "KMER_PATHS": {
