...
def main() -> None:
    ...
    outputs = {
        RESULT_ROOT
        / "postqc_monotherapy_duplicate_overall_summary.tsv":
            overall_summary,

        RESULT_ROOT
        / "postqc_monotherapy_duplicate_class_summary.tsv":
            class_summary,

        RESULT_ROOT
        / "postqc_monotherapy_duplicate_group_size_distribution.tsv":
            size_distribution,

        RESULT_ROOT
        / "postqc_monotherapy_duplicate_species_summary.tsv":
            species_summary,

        RESULT_ROOT
        / "postqc_monotherapy_duplicate_antibiotic_summary.tsv":
            antibiotic_summary,

        AUDIT_ROOT
        / "postqc_monotherapy_repeated_group_audit.tsv":
            repeated_audit,

        AUDIT_ROOT
        / "postqc_monotherapy_conflicting_records.tsv":
            conflict_records,
    }
